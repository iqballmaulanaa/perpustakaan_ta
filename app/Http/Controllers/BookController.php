...
class BookController extends Controller
{
    ...
    public function update(Request $request, Book $book)
    {
        ...
        if ($request->hasFile('book_cover') && $book->book_cover) {
    ...
    // ✅ Tambahkan method search di bawah ini
// BookController.php

public function search(Request $request)
{
    $books = Book::with(['category', 'rack', 'bookStock'])->get(); // Ambil semua buku beserta relasi
