...
@section('content')
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <h5 class="card-title fw-bold mb-4 text-center">Atau cari anggota</h5>
   ...
   <script>
    ...
    function handleQrCodeScanned(decodedText) {
        // Clear table content before displaying new scan result
            ...
            success: function(response) {
                // Check if updated_at is more than 1 minute ago
                    ...
                    if (minuteDifference > 1) {
                        // Display expired message if more than 1 minute has passed
                        Swal.fire({
                            icon: 'error',
...
<tr>
    ...
    <td>${response.member.nis ?? '-'}</td>
    <td>${response.member.kelas ?? '-'}</td>
    <td>${response.member.gender ?? '-'}</td>
    <td>
...
`);
                    ...
                    // Display alert that QR code is not registered
                    Swal.fire({
                        icon: 'error',
